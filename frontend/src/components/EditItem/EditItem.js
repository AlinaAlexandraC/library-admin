        ...
        <div className="edit-item-container">
            ...
            {editedTitle.type === "Anime" && (
                <>
                    ...
                    <input type="text" name="title" value={editedTitle.numberOfSeasons} onChange={handleChange} className="title-input" placeholder="no of seasons"
                    />
                    <input type="number" name="title" value={editedTitle.numberOfEpisodes} onChange={handleChange} className="title-input" placeholder="no of episodes"
                    />
                </>
            )}
            ...
            {editedTitle.type === "Manga" && (
                <input type="number" name="title" value={editedTitle.numberOfChapters} onChange={handleChange} className="title-input" placeholder="no of chapters"
                />
            )}
